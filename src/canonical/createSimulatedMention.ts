 ...
 * Auto-prefixes @gorky (or BOT_USERNAME) when missing.
 */

import type { CanonicalEvent } from "./types.js";

const BOT_HANDLE = (process.env.BOT_USERNAME ?? "gorky").replace(/^@/, "");
...
/** Ensures text starts with @gorky (or BOT_USERNAME) to simulate a real mention. */

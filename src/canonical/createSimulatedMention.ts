 ...
 * Auto-prefixes @twimsalot (or BOT_USERNAME) when missing.
 */

import type { CanonicalEvent } from "./types.js";

const BOT_HANDLE = (process.env.BOT_USERNAME ?? "twimsalot").replace(/^@/, "");
...
/** Ensures text starts with @twimsalot (or BOT_USERNAME) to simulate a real mention. */

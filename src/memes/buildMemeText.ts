...
const DEFAULT_HEADERS: Partial<Record<TemplateKey, string>> = {
  twimsalot_courtroom: "COURT OF MARKET REALITY",
  twimsalot_chart_autopsy: "CHART AUTOPSY REPORT",
  twimsalot_ghost: "LIQUIDITY GHOST DETECTED",
  twimsalot_certificate: "OFFICIAL CERTIFICATION",
  twimsalot_trade_screen: "LIVE TRADING FOOTAGE"
};

const DEFAULT_FOOTERS: Partial<Record<TemplateKey, string>> = {
  twimsalot_courtroom: "SENTENCED TO HOLDING",
  twimsalot_chart_autopsy: "TIME OF DEATH: LIQUIDITY EVENT",
  twimsalot_certificate: "ISSUED BY twimsalot ENTITY",
  twimsalot_trade_screen: "EMOTIONAL DAMAGE DETECTED"
};
...
const BANK: Record<TemplateKey, Record<string, string[]>> = {
  ...
  twimsalot_certificate: {
    ...
    footer: ["ISSUED BY twimsalot ENTITY", "VALID UNTIL NEXT RUG", "NO REFUNDS ON DEGENERACY"]
  },

...
5. `README.md` hat inkonsistente Default-Werte (BOT_USERNAME: `serGorky` vs `twimsalot_on_sol`)
...
|--------|-----------|------------------|
| `BOT_USERNAME` Default | `serGorky` | `twimsalot_on_sol` |

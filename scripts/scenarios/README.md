...
```json
{"name":"szenario-name","turns":[{"userInput":"...","skipPipeline":true},{"userInput":"@gorkypf ...","expectedKeywords":["keyword1","keyword2"]}]}
```
...
|------|-----|--------------|
| `userInput` | string | User-Nachricht (mit oder ohne @gorkypf) |
